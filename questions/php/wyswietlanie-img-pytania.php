...
function getRandomImage($kategoria, $punkty,$conn) {
    $result = mysqli_query($conn, "SELECT img_pytania FROM mvc_konkurs_pytania WHERE kategoria='$kategoria' AND poziom=$punkty AND (YEAR(CURDATE())-rok_uzycia)>=5 ORDER BY RAND() LIMIT 1;");
